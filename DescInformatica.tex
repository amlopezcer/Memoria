...
Para una mejor comprensión, a continuación se aporta, por entidad, una introducción de la API implementada en el servidor a nivel de las diferentes URLs. Esta introducción pretende describir la funcionalidad general de cada método, dejando el detalle de cada uno descrito en el anexo~\ref{app:appAPI}.
